...
class Database {
    ...
    let media_timestamp = Expression<Int>("timestamp")
    ...
    let favoritedOn = Expression<Int>("favorited_on")
    let statsOwn_lastViewed = Expression<Int>("last_viewed")
